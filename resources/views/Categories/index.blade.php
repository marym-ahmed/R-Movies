...
<body>
                        ...
                        <ul class="dropdown-menu  mr-5">
                            ...
                            <li><span class="dropdown-item w-100">
                                    <form action="{{ route('deleteAcount', auth()->id())}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button id="delete" class="btn btn-outline-danger ms-1 w-100" type="submit">Delete Your Account</button>
                                    </form>
                                </span></li>
                        </ul>
                    </li>
    ...
    <div class="containerCategory mt-2 text-center"id="categ">
        <div class="row">
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('categories.destroy',$category->id) }}" method="Post">
                            <a id="editbtn" type="button" class="btn btn-outline-info" href="{{ route('categories.edit',$category->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                            @csrf
                            @method('DELETE')

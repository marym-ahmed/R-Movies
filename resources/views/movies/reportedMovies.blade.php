            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-center ">
                        ...
                        @csrf
                        <a id="showbtn" class="btn btn-outline-warning me-2" href="{{ route('movie.show',$movie->id) }}"><i class="fa-solid fa-eye"></i></a>
                        <form action="{{ route('movie.destroy',$movie->id) }}" method="Post">
                            @csrf
                            @method('DELETE')
                            <button id="deletebtn" type="submit" class="btn btn-outline-primary"> <i type="submit" class="fa-solid fa-trash-can"></i></button>
                        </form>
                        <a id="cbtn" href="{{ route('deletereport', $report->movie_id)}}" class="btn btn-outline-primary"><i class="fa-solid fa-xmark"></i></a>
                    </div>
